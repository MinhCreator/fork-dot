...
paru -Syu --needed --noconfirm ente-auth-bin visual-studio-code-bin steam prismlauncher discord ayugram-desktop-bin telegram-desktop spotify spicetify-cli jdk8-openjdk jdk17-openjdk jdk21-openjdk cava peaclock obs-studio gpu-screen-recorder gpu-screen-recorder-ui
```
install vencord:
```
